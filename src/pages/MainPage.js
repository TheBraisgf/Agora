    ...
    <div className="mainPage">
      ...
      {step === 2 && (
        <div className="result accepted">
          ...
          <p>
            **El Ágora es un refugio para los que buscan más.** No es solo un
            grupo, sino un punto de encuentro para aquellos que aman el
            conocimiento, la tecnología, la filosofía, la literatura, el cine,
            los videojuegos y el aprendizaje en todas sus formas. Aquí no hay
            espacio para la mediocridad ni el conformismo.
          </p>

          <h3>⚖️ ¿Cómo funciona?</h3>
          <p>
            Somos una comunidad en crecimiento, aún no somos muchos, pero cada
            miembro cuenta. Nos reunimos en **WhatsApp y Discord** para
            compartir ideas, debatir y organizarnos. No es un grupo de memes ni
            de spam. Aquí valoramos el **pensamiento, la creatividad y la
            curiosidad.**
          </p>
          ...
          <ul>
            <li>
              🔥 **Preséntate** al entrar. No somos tantos aún, así que cada voz
              es importante.
            </li>
            <li>
              🧠 **Comparte ideas, preguntas y conocimientos.** No tengas miedo
              de hablar.
            </li>
            <li>
              ⚔️ **Sé parte de la construcción de este lugar.** Ayúdanos a hacer
              del Ágora una comunidad vibrante.
            </li>
          </ul>

          <h3>⚔️ Código de Honor del Ágora</h3>
          <p className="arconte-message">
            **"El conocimiento es poder, y el debate es la llama que lo aviva.
            Aquí se valora la curiosidad, el respeto y el aprendizaje. No
            buscamos seguidores, sino pensadores. Sé digno, comparte, aprende y
            ayuda a construir el futuro del Ágora."**
          </p>
      ...
      {step === 3 && (
        <div className="result rejected">
          <h2>🔥 ¡NO ERES DIGNO! 🔥</h2>
          <p>
            "Normie... Tu mente cerrada y tu estilo de vida básico no tienen
            cabida aquí. Regresa a tu mundo de fútbol, telebasura y noches
            vacías de fiesta."
          </p>
          <p className="burning-text">
            Tu cabeza explota en llamas por la vergüenza...
          </p>
        </div>
      )}
